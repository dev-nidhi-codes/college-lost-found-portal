...
import { saveFoundItem } from "@/lib/utils";
...
const ReportFound = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const savedItem = saveFoundItem(formData);
      ...
      toast({
        ...
        description: "The item has been saved locally and the owner will be able to see your listing.",
      });
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Help someone reunite with their lost item by reporting what you found
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g., Library 2nd floor, Near cafeteria entrance, Building A room 205"
                    required
                  />
                </div>
              ...
              <div className="bg-accent/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  For security reasons, please verify the identity of anyone claiming the item. 
                  Ask them to describe specific details about the item before arranging pickup.
                </p>
              </div>
